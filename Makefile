...
CC_IGNORE=-i "coverage.*" -i "docs/*" -i "tests/temp/*" -i "www/dist/*" -i ".vscode/*" -i "packages/frontend/junit.xml" -i "packages/*/coverage/*" -i "packages/*/dist/*" -i "packages/*/docs/*" -i "tests/iqrf-gateway-webapp.postman_collection.json" -i "tests/data/gatewayInfo/syntax_error/iqrf-gateway.json"
