...
class AuthenticationMiddleware implements IMiddleware {
	...
	protected function isWhitelisted(ServerRequestInterface $request): bool {
		...
		if (
			...
			Strings::match($requestUrl, '#^/api/v0/account/verification/[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$#') !== null ||
			Strings::match($requestUrl, '#^/api/v0/account/password/recovery/[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$#') !== null ||
			Strings::match($requestUrl, '#^/api/v0/account/password/set/[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$#') !== null ||
	...
	public function __invoke(
		...
		if ($identity instanceof User) {
			if ($identity->getState()->isBlocked()) {
