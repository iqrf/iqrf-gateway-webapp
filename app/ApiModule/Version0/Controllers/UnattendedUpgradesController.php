...
/**
 * Unattended upgrades controller
 * @Path("/unattendedUpgrades")
 * @Tag("Unattended upgrades manager")
 */
class UnattendedUpgradesController extends BaseController {

	/**
	 * @var UnattendedUpgradesManager Unattended upgrades service manager
	 */
	private $manager;

	/**
	 * Constructor
	 * @param UnattendedUpgradesManager $manager Unattended upgrades service manager
	 */
	 ...
	 * @Method("GET")
	 * @OpenApi("
	 *   summary: Returns status of Unattended upgrades service
	 * ")
	 * @Responses({
	 ...
	 * @Method("POST")
	 * @OpenApi("
	 *   summary: Enables Unattended upgrades service
	 * ")
	 * @Responses({
	 *      @Response(code="200", description="Success")
	 * })
	 ...
	 * @Method("POST")
	 * @OpenApi("
	 *   summary: Disables Unattended upgrades service
	 * ")
	 * @Responses({
	 *      @Response(code="200", description="Success")
	 * })
