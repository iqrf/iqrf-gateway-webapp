...
export default class BondingManager extends Vue {
	...
	/**
<<<<<<< HEAD:src/components/IqrfNet/NetworkManager/BondingManager.vue
	...
	/**
=======
>>>>>>> f81101d82 (Iqrfnet: use iqmesh ping, added nodes restart, dpa params and maintenance iqmesh services support):src/components/IqrfNet/NetworkManager/Iqmesh/BondingManager.vue
