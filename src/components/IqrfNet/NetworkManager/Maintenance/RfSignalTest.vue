...
<template>
	<v-card flat tile>
		...
		<RfSignalTestResultDialog ref='resultDialog' />
	</v-card>
</template>

<script lang='ts'>
import {Component, Vue} from 'vue-property-decorator';
import RfSignalTestResultDialog from './RfSignalTestResultDialog.vue';
...
export default class RfSignalTest extends Vue {
	...
	private showResults(): void {
		(this.$refs.resultDialog as RfSignalTestResultDialog).showDialog(this.results);
	}
}
</script>
