 ...
 */
export interface IqrfDbDeviceBrief {
	/**
	 * Device address
	 */
	address: number;
 ...
 */
export interface IqrfDbDeviceFull extends IqrfDbDeviceBrief {
	/**
	 * Device module ID
	 */
	mid: number;
...
export interface IqrfDbSensor {
	 ...
	 * Array of sensors
	 */
	sensors: IqrfDbSensorDetails[];
}

/**
 * Database sensor details interface
 */
export interface IqrfDbSensorDetails {
	/**
	 * Sensor index
	 */
	index: number;
 ...
 */
export interface IqrfDbDeviceMetadata {
	/**
	 * Device address
	 */
	address: number;
	 ...
	 * Metadata object
	 */
	metadata: IqrfDbMetadata;
}

/**
 * Device metadata object interface
 */
export interface IqrfDbMetadata {
	/**
	 * Device name
	 */
	name?: string|null;
