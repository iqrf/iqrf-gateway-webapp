...
/**
 * TEST: App\NetworkModule\Models\GsmManager
 * @covers App\NetworkModule\Models\GsmManager
 * @phpVersion >= 7.4
 * @testCase
 */
/**
 ...
 */
final class GsmManagerTest extends TestCase {
	...
	protected function setUp(): void {
		...
		$this->manager = new GsmManager($this->commandExecutor);
	}

}
$test = new GsmManagerTest();
$test->run();
