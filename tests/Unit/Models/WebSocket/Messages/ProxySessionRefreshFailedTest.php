...
/**
 * TEST: App\Models\WebSocket\Messages\ProxySessionRefreshFailed
 * @covers App\Models\WebSocket\Messages\ProxySessionRefreshFailed
 * @phpVersion >= 8.2
 * @testCase
 */
/**
...
/**
 * Tests for ProxySessionRefreshFailed class
 */
final class ProxySessionRefreshFailedTest extends TestCase {
	 ...
	 */
	private ProxySessionRefreshFailed $message;
	...
	public function testJsonSerialize(): void {
		Assert::equal(
			[
				'type' => ProxyMessageType::PROXY_SESSION_REFRESH_FAILED->value,
...
$test = new ProxySessionRefreshFailedTest();
$test->run();
