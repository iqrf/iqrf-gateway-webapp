...
/**
 * TEST: App\Models\WebSocket\Messages\ProxySessionExpired
 * @covers App\Models\WebSocket\Messages\ProxySessionExpired
 * @phpVersion >= 8.2
 * @testCase
 */
/**
...
/**
 * Tests for ProxySessionExpired class
 */
final class ProxySessionExpiredTest extends TestCase {
	...
	/**
	 * @var ProxySessionExpired Message object
	 */
	private ProxySessionExpired $message;
	...
	public function testJsonSerialize(): void {
		Assert::equal(
			[
				'type' => ProxyMessageType::PROXY_SESSION_EXPIRED->value,
	...
	public function testToJsonString(): void {
		Assert::same(
			'{"type":"proxy_session_expired","timestamp":"2026-01-01T10:00:00+00:00"}',
	...
	protected function setUp(): void {
		...
		$this->message = new ProxySessionExpired($this->dt);
	}

}

$test = new ProxySessionExpiredTest();
$test->run();
