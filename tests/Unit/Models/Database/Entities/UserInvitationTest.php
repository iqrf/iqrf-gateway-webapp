...
/**
 * TEST: App\Models\Database\Entities\UserInvitation
 * @covers App\Models\Database\Entities\UserInvitation
 * @phpVersion >= 8.2
 * @testCase
 */
/**
...
final class UserInvitationTest extends TestCase {
	...
	/**
	 * @var UserInvitation User invitation entity
	 */
	private UserInvitation $entity;
