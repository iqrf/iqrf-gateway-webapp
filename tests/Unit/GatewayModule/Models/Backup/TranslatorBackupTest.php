...
/**
 * TEST: App\GatewayModule\Models\Backup\TranslatorBackup
 * @covers App\GatewayModule\Models\Backup\TranslatorBackup
 * @phpVersion >= 8.2
 * @testCase
 */
/**
...
/**
 * Tests for backup manager for IQRF Gateway Translator daemon
 */
final class TranslatorBackupTest extends BackupManagerTestCase {
	...
	public function testGetServices(): void {
		...
		Assert::same(['iqrf-gateway-translator'], $this->managerEnabled->getServices());
	}
