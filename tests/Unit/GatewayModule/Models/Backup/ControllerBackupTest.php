...
/**
 * Tests for backup manager for IQRF Gateway Controller daemon
 */
final class ControllerBackupTest extends BackupManagerTestCase {
	...
	public function testGetServices(): void {
		...
		Assert::same(['iqrf-gateway-controller'], $this->managerEnabled->getServices());
	}
