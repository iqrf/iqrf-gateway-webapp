...
/**
 * TEST: App\IqrfNetModule\Parser\CoordinatorParser
 * @covers App\IqrfNetModule\Parser\CoordinatorParser
 * @phpVersion >= 7.0
 * @testCase
 */
declare(strict_types = 1);

namespace Test\IqrfNetModule\Parser;

use App\CoreModule\Model\JsonFileManager;
use App\IqrfNetModule\Parser\CoordinatorParser;
