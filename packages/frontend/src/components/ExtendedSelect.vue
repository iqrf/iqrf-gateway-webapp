...
@Component
export default class ExtendedSelect extends Vue {
	/**
	 * @property {PropType<any>} model Select model
	 */
	@VModel({required: true}) model!: PropType<any>;

	/**
	 * @property {Array<ISelectItem>} items Select items
	 */
	@Prop({required: false, type: Array}) items!: Array<ISelectItem>;
	...
	/**
	 * @property {string} description Select description/hint
	 */
