...
import { IqrfGatewayControllerLoggingSeverity } from '@iqrf/iqrf-gateway-webapp-client/types/Config';
...
const modelValue = defineModel<IqrfGatewayControllerLoggingSeverity>({
	required: true,
});
