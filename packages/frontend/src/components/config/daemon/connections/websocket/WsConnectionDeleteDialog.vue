...
<template>
	...
	>
		<template #title>
			{{ $t('components.config.daemon.connections.websocket.delete.title') }}
		</template>
		{{ $t('components.config.daemon.connections.websocket.delete.prompt', { name: connectionProfile.messaging.instance }) }}
	</IDeleteModalWindow>
</template>
