	...
	>
		<ICard>
			...
			<v-file-input
				...
				:rules='[
					(v: File|null) => ValidationRules.required(v, $t("components.maintenance.backup.restore.validation.archive.required")), (v: File) => ValidationRules.fileExtension(v, ["zip"], $t("components.maintenance.backup.restore.validation.archive.fileExtension")),
				]'
