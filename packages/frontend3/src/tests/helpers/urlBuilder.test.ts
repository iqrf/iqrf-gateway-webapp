...
describe('URL builder', (): void => {
	...
	it('get hostname', async (): Promise<void> => {
		expect.assertions(1);
		setMode('development');
	...
	it('get port', async (): Promise<void> => {
		expect.assertions(1);
		setMode('development');
		const builder: UrlBuilder = new UrlBuilder();
	...
	it('get base URL in development mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get REST API URL from environmental variable', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get REST API URL in development mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get REST API URL in production mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get REST API URL from hostname', async (): Promise<void> => {
		expect.assertions(2);
		setMode('development');
		const builder: UrlBuilder = new UrlBuilder();
	...
	it('get IQRF Gateway Daemon JSON API URL from environmental variable', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF Gateway Daemon JSON API URL in development mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF Gateway Daemon JSON API URL in production mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF Gateway Daemon monitor URL from environmental variable', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF Gateway Daemon monitor URL in development mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF Gateway Daemon monitor URL in production mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF network sync URL from environmental variable', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF network sync URL in development mode', async (): Promise<void> => {
		expect.assertions(1);
	...
	it('get IQRF network sync URL in production mode', async (): Promise<void> => {
		expect.assertions(1);
