...
export enum AccessScope {
	...
	config_translator_read = 'config:translator:read',
	config_translator_write = 'config:translator:write',
	...
	ipNetwork_vpns_execute = 'ipNetwork:vpns:execute',
	...
	openApi_read = 'openApi:read',
	security_apiKeys_read = 'security:apiKeys:read',
	security_apiKeys_write = 'security:apiKeys:write',
	security_daemonAccessTokens_read = 'security:daemonAccessTokens:read',
	security_daemonAccessTokens_write = 'security:daemonAccessTokens:write',
	security_certificates_read = 'security:certificates:read',
	security_certificates_write = 'security:certificates:write',
	security_mosquittoUsers_read = 'security:mosquittoUsers:read',
	security_mosquittoUsers_write = 'security:mosquittoUsers:write',
	security_role_read = 'security:role:read',
	security_role_write = 'security:role:write',
